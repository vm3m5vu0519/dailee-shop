function orders() {
                ...
                $.ajax({
                    type: 'get',
                    url: baseUrl+'/dailee/orders/'+username+"/advance"+parameter_url,
                    datatype: 'json',
                    ...
                    success: function (response) {
                        ...
                        orderConfirm.data = {
                            ...
                            html_address : function() {
                                var HTML = '';
                                HTML += '<p>收貨人信息<span class="rt" id="choose">新增收货地址</span></p>'
                            ...
                            addads: function () {
                                ...
                                var id = 0
                                if (receiverName && receiverCity && receiverDistrict && receiverAddress &&
                                    receiverMobile) {
                                    $.ajax({
                                        type: 'post',
