        ...
        delItem: function (index) {
            $(".Each input[type='checkbox']").each(function (i, e) {
                if ($(e).val() == index) {
                    ...
                    if (username){
                        $.ajax({
                        url: BASE_URL+'/dailee/carts/' + username,
                        type: "DELETE",
                 ...
                 request.setRequestHeader('authorization',window.localStorage.getItem('token'))
                        ...
                        success: function (result) {
                           ...
                           if(results.code == 403){
			                ...
			                window.localStorage.setItem('count',results.data.carts_count)
         ...
         $.ajax({
             ...
             success: function (reponse) {
                 ...
                 if (results.code == 200) {
                     ...
                     console.log(data)
			         window.localStorage.setItem('count',results.data.length)
